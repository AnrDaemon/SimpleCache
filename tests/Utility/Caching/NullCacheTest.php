...
extends TestCase
{
    ...
    */
    public function testNoInitializeCacheAtCreation()
    {
    ...
    */
    public function testAddItemToCache()
    {
        ...
        $this->assertFalse($cache->set($index, $value), "Failed adding item '$index' to cache!");
        $this->assertFalse($cache->has($index), "Item '$index' not found in cache!");
    }
